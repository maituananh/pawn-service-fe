                    ...
                    <Flex vertical gap={32} style={{ flex: "1 1 500px" }}>
                        <Flex vertical gap={12}>
                            ...
                            <Text style={{ color: "rgba(255, 255, 255, 0.65)", fontSize: 16 }}>
                                Luôn an tâm vì tài sản được niêm phong bằng tem vỡ và bảo quản với quy trình chuyên
                                nghiệp.
                            </Text>
                        </Flex>
                        ...
                        >
                            ...
                            >
                                ...
                                trong 12 tháng, lãi suất vay 2.5%/tháng tương đương 250.000đ/tháng. Tổng nợ gốc và lãi
                                trong 12 tháng là 13.000.000đ. Khách hàng có thể chọn trả lãi hàng tháng mà không cần
                                trả nợ gốc ngay.
                            </Paragraph>
                        </Card>
                    </Flex>
