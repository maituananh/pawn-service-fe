...
import { Card, Divider, Flex, Layout, List, theme, Typography } from "antd";
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <Flex gap={64} wrap="wrap" justify="space-between">
          ...
          <Flex vertical gap={32} style={{ flex: "1 1 500px" }}>
            <Flex vertical gap={12}>
              ...
              >
                Luôn an tâm vì tài sản được niêm phong bằng tem vỡ và bảo quản
            ...
            >
              ...
              >
                ...
                trong 12 tháng, lãi suất vay 2.5%/tháng tương đương
                250.000đ/tháng. Tổng nợ gốc và lãi trong 12 tháng là
                13.000.000đ. Khách hàng có thể chọn trả lãi hàng tháng mà không
                cần trả nợ gốc ngay.
              </Paragraph>
            </Card>
          </Flex>
          ...
          <Flex vertical align="center" gap={32} style={{ flex: "1 1 300px" }}>
            <div
              style={{
                ...
                borderRadius: "50%",
                background:
                  "radial-gradient(circle, rgba(22, 119, 255, 0.1) 0%, rgba(10, 10, 10, 0) 70%)",
                display: "flex",
                alignItems: "center",
            ...
            >
              ...
              >
                Hệ thống lưu trữ hiện đại, bảo hiểm tài sản lên đến 100% giá
                trị.
              </Text>
            </Flex>
          </Flex>
        ...
        <Divider
          style={{ borderColor: "rgba(255, 255, 255, 0.1)", margin: "48px 0" }}
        />

        <Flex justify="space-between" align="center" wrap="wrap" gap={16}>
          <Text style={{ color: "rgba(255, 255, 255, 0.35)", fontSize: 13 }}>
            © {new Date().getFullYear()} Camdo{" "}
          ...
          <Flex gap={24}>
            <Link style={{ color: "rgba(255, 255, 255, 0.35)", fontSize: 13 }}>
              Điều khoản sử dụng
            </Link>
            <Link style={{ color: "rgba(255, 255, 255, 0.35)", fontSize: 13 }}>
              Chính sách bảo mật
