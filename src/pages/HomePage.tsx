      ...
      <Flex vertical align="center" gap={48}>
        ...
        <Flex vertical align="center" gap={32} style={{ width: '100%' }}>
          <Flex vertical align="center" gap={8}>
            <Title level={2} style={{ margin: 0, fontWeight: 700 }}>Quy trình cầm đồ</Title>
            <Text type="secondary" style={{ fontSize: 16 }}>Đơn giản, minh bạch và nhanh chóng</Text>
          </Flex>
                ...
                >
                  <Flex vertical align="center" gap={16}>
                    <div style={{ 
                      ...
                      <img src={step.image} alt={step.title} style={{ height: 40 }} />
                    </div>
        ...
        <Flex vertical align="center" gap={32} style={{ width: '100%' }}>
          <Flex vertical align="center" gap={8}>
            <Title level={2} style={{ margin: 0, fontWeight: 700 }}>Tài sản được chấp nhận</Title>
            <Text type="secondary" style={{ fontSize: 16 }}>Định giá cao, lãi suất ưu đãi cho mọi loại tài sản</Text>
          </Flex>
          ...
          <Row gutter={[24, 24]} style={{ width: '100%' }}>
            {assets.map((item, index) => (
              <Col key={index} xs={12} sm={8} md={6}>
                ...
                >
                  <Flex vertical align="center" gap={16}>
                    <img src={item.image} alt={item.label} style={{ height: 64, objectFit: 'contain' }} />
