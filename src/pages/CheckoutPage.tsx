...
import { Button, Card, Col, Divider, Form, Input, Radio, Row, Space, Typography, message } from "antd";
...
const CheckoutPage = () => {
    ...
    const selectedItems = cart.filter((item) => cartItemIds?.includes(item.cartItemId));
            ...
            <Row gutter={[32, 32]}>
                                        ...
                                        >
                                            <Space>
                                                <img
                                                    ...
                                                    height={20}
                                                />
                                                <Text strong>Thanh toán qua Stripe (Visa/Mastercard)</Text>
                                            </Space>
                                        </Radio.Button>
                                        <Radio.Button
                ...
                <Col xs={24} lg={9}>
                    ...
                    >
                        ...
                        >
                            Bằng cách đặt hàng, bạn đồng ý với các Điều khoản & Chính sách của chúng tôi.
                        </Paragraph>
                    </Card>
                </Col>
            </Row>
