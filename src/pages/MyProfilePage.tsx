...
import { EditOutlined, MailOutlined, SaveOutlined, UploadOutlined, UserOutlined } from "@ant-design/icons";
import { Avatar, Button, Card, Col, Form, Input, message, Row, Select, Spin, Typography, Upload } from "antd";
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                ...
                const initialAvatar =
                    getImageUrl(profile.avatar) || profile.avatarUrl || "https://via.placeholder.com/150";
