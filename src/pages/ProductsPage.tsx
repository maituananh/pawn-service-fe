...
import { Alert, Button, Checkbox, Flex, Input, Pagination, Typography } from "antd";
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Button block onClick={handleClearFilters} style={{ height: 40, borderRadius: 8, fontWeight: 500 }}>
                    Xóa bộ lọc
                </Button>
            </div>
